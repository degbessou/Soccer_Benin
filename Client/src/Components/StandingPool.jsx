                    ...
                    <table className="w-full table-auto text-sm">
                        ...
                        <tbody className="divide-y divide-gray-300">
                            {standing.map((team, idx) => {
                                ...
                                return (
                                    <tr
                                        key={team.id_standing || team.abreviation}
                                        className={
                                            isPromoted
                                                ? 'bg-green-50'
                                                : isRelegated
                                    ...
                                    >
                                        ...
                                        <td
                                            className={`py-3 px-3 text-center font-medium ${team.difference_buts > 0
                                                ? 'text-green-600'
                                                : team.difference_buts < 0
                                                    ? 'text-red-600'
                                                    : ''
                                                }`}
                                        >
                                            {team.difference_buts > 0 ? '+' : ''}
                                            {team.difference_buts}
                                        </td>
                                    </tr>
                                )
                            })}
                ...
                <div className="md:hidden">
                    {standing.map((team, idx) => {
                        ...
                        return (
                            <div
                                key={team.id_standing || team.abreviation}
                                className={`p-4 border-b border-gray-300 ${isPromoted
                                    ? 'bg-green-50'
                                    : isRelegated
                                        ? 'bg-red-50'
                                        : ''
                            ...
                            >
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-3">
                                        <span
                                            className={`text-lg font-bold ${isPromoted
                                                ? 'text-green-600'
                                                : isRelegated
                                                    ? 'text-red-600'
                                                    : 'text-gray-800'
